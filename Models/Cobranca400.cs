...
namespace BRD_API_NF_4_7_2_TRANSMISSAO.Models
{
    public class Cobranca400
    {
        ...
        public void ValidarCamposTipo1()
        {
            ...
            {
                listaDeErros.Add(erroNome + linhaAtual + idNome + IdentificacaoRegistroTipo1 + " Posição : 066 a 070 {Campo de Multa + Percentual de Multa");
            }
            ...
            {
                listaDeErros.Add(erroNome + linhaAtual + idNome + IdentificacaoRegistroTipo1 + " Posição : 148 a 149 {Campo Espécie de título}");
            }
            ...
            {
                listaDeErros.Add(erroNome + linhaAtual + idNome + IdentificacaoRegistroTipo1 + " Posição : 219 a 220 {Campo Identificação do Tipo de Inscrição do Pagador}");
            }

            // Valida CPF e CNPJ
            if (NumeroInscricaoPagador == "00000000000000")
            {
                listaDeErros.Add(erroNome + linhaAtual + idNome + IdentificacaoRegistroTipo1 + " Posição : 221 a 234 {Campo Número de Inscrição do Pagador}");
            }
        }
        #endregion
        #endregion
        ...
        public void TrataErrosTipo2()
        {
            ...
            if (Mensagem2.Trim().Length < 41 && Mensagem2.Trim().Length > 0)
                listaDeErros.Add(erroNome + linhaAtual + idNome + NumeroSequencialRegistro2 + " Mensagem2 Posição : 082 a 161 , menor que 41 caracteres");
            if (Mensagem3.Trim().Length < 41 && Mensagem3.Trim().Length > 0)
                listaDeErros.Add(erroNome + linhaAtual + idNome + NumeroSequencialRegistro2 + " Mensagem3 Posição : 162 a 241 , menor que 41 caracteres");
            if (Mensagem4.Trim().Length < 41 && Mensagem4.Trim().Length > 0)
                listaDeErros.Add(erroNome + linhaAtual + idNome + NumeroSequencialRegistro2 + " Mensagem4 Posição : 242 a 321 , menor que 41 caracteres");
        }
        #endregion
        #endregion
